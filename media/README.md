...
The Arr suite monitors for new releases and sends download commands to Transmission/Aria2. Once complete, files are automatically moved to the Plex library.
